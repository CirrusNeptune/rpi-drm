...
pub const fn vpm_block_write_horizontal_32(stride: u8, y: u8) -> u32 {
    ((stride as u32) << 12) | (1 << 11) | ((VpmSize::_32bit as u32) << 8) | (y as u32)
}
...
pub fn assemble() {
    const BLAH: [u64; 14] = qpu!{
        ...
        sig_load_imm ; vr_setup = load32.always(vpm_block_read_horizontal_32(2, 1, 0)) ; nop = load32.always() ;
        //uni = viewportXScale
        //r0 = vpm * uni
        ...
        //horizontal
        //stride = 1
        sig_load_imm ; vw_setup = load32.always.ws(vpm_block_write_horizontal_32(1, 0)) ; nop = load32.always() ;
